...
from epic_cron.repositories.submit_repository import InvitationEmailData
...
class InvitationEmailService:  # pylint: disable=too-few-public-methods
    ...
    def prepare_invitation_email_notification(cls, invitation: InvitationEmailData) -> EmailDetails:
        ...
        if invitation.role_name == constants.ROLE_ACCOUNT_PRIMARY_ADMIN:
            invitation_action_text = "manage"
        elif invitation.role_name == constants.ROLE_SPECIFIC_SUBMISSION_CONTRIBUTOR:
        ...
        return EmailDetails(
            template_name=constants.NEW_USER_INVITATION_EMAIL_TEMPLATE,
            body_args={
